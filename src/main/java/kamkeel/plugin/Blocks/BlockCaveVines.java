...
public class BlockCaveVines extends BlockBush
{
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighbour, BlockPos fromPos) {
        ...
        if (world.isAirBlock(pos.down()) && world.getBlockState(pos).getBlock() == ModBlocks.caveVines) {
    ...
    public static boolean canPlaceRootBelow(final World world, final BlockPos pos) {
        ...
        return blockAbove.getMaterial(world.getBlockState(pos)) != Material.LEAVES;
    }
